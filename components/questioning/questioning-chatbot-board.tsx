...
const evaluationRecordColumns = [
  ...
  { label: "질문하기", placeholder: "0~5" },
  { label: "지문 이해", placeholder: "0~5" },
  { label: "성취기준 점수", placeholder: "0~5" },
...
const evaluationRecordGuideRows = [
  ...
  {
    label: "질문하기",
    guide: "1국면에서 학생이 스스로 만든 질문의 수와 이어 간 행동을 0~5점으로 입력합니다.",
    use: "질문의 좋고 나쁨이 아니라 스스로 궁금해한 행동을 확인합니다.",
  },
  {
    label: "지문 이해",
    guide: "1국면의 낱말·사실 질문과 2국면 이해 확인 질문에 대한 답을 합쳐 0~5점으로 입력합니다.",
    use: "지문의 낱말, 사실, 관계를 이해한 증거를 확인합니다.",
  },
  {
    label: "성취기준 점수",
    guide: "성취기준과 교사 메모에서 뽑은 표적 질문과 응답을 0~5점으로 입력합니다.",
    use: "수업에서 강조한 표적 행동에 닿았는지 확인합니다.",
  },
  {
    label: "성찰질문과 의견 표현",
    guide: "마지막 생각·의견 질문에 자기 생각을 표현한 정도를 0~5점으로 입력합니다.",
    use: "자기 생각, 까닭, 지문 연결을 확인합니다.",
  },
  {
    label: "총점",
...
22. 이해하기 어려운 문장을 짚으면 원문을 확인한 뒤 말만 쉬운 표현으로 바꾸고, 숫자·주체·시점과 사실은 그대로 보존한다. 보존 여부가 의심되면 원문을 그대로 인용한다.

### 3-3. 두 국면 전환
- 1국면에서는 학생이 먼저 묻는다. 지문 관련 질문 네 개가 쌓이면 2국면으로 전환한다.
- 3~4턴이 지났는데 지문 관련 질문이 하나 이하이면 B1을 한 번만 묻는다: “혹시 지문에서 모르는 단어나 이해하기 어려운 문장이 있나요?”
- 학생이 낱말이나 문장을 대면 답한 뒤 1국면으로 돌아간다. 없다고 하면 B2를 한 번 말하고 2국면으로 전환한다.
- 2국면 질문은 지문 이해 1~2개, 성취기준 표적 1~2개, 생각·의견 1개 순서다. 마지막 생각·의견 질문은 반드시 묻는다.
- 중 난이도에서 시작하고, 근거 있는 답이면 상으로 올린다. 막히면 하로 내려 지문의 볼 곳을 짚고, 하에서도 막히면 답이 든 문장을 함께 읽는다.
