...
export const standardOptions: StandardOption[] = [
  {
    ...
    subject: "국어",
    gradeBand: "초등 3-4학년",
    title: "[4국01-05] 자료를 정리하여 발표하기",
    standard: "[4국01-05] 목적과 주제에 알맞게 자료를 정리하여 자신감 있게 발표한다.",
    classroomGoal: "신문기사에서 핵심 자료를 골라 발표 내용으로 정리하고 친구들과 공유합니다.",
  },
  {
    id: "korean-4-02-03",
    subject: "국어",
  ...
  },
  {
    ...
    subject: "국어",
    gradeBand: "초등 3-4학년",
    title: "[4국03-03] 의견과 이유가 드러나는 글쓰기",
    standard: "[4국03-03] 대상에 대한 자신의 의견과 그렇게 생각한 이유가 드러나게 글을 쓴다.",
    classroomGoal: "기사에 대한 자신의 의견을 정하고 기사에서 찾은 이유와 함께 댓글로 씁니다.",
  },
  {
    id: "korean-4-06-01",
    subject: "국어",
    gradeBand: "초등 3-4학년",
    title: "[4국06-01] 목적에 맞는 인터넷 자료 선택",
    standard: "[4국06-01] 인터넷에서 학습에 필요한 다양한 자료를 탐색하고 목적에 맞게 자료를 선택한다.",
    classroomGoal: "학습 주제와 관련된 기사와 자료를 찾아 목적에 맞는 자료인지 판단합니다.",
  },
  {
    id: "korean-4-06-02",
    subject: "국어",
    gradeBand: "초등 3-4학년",
    title: "[4국06-02] 매체 발표 자료 만들기",
    standard: "[4국06-02] 매체를 활용하여 간단한 발표 자료를 만든다.",
    classroomGoal: "기사의 핵심 내용과 자신의 생각을 간단한 매체 발표 자료로 구성합니다.",
  },
  {
    id: "korean-4-06-03",
    subject: "국어",
    gradeBand: "초등 3-4학년",
    title: "[4국06-03] 매체 소통 윤리",
    standard: "[4국06-03] 매체 소통 윤리를 고려하여 매체 자료를 활용하고 공유한다.",
    classroomGoal: "기사와 친구의 의견을 존중하며 출처와 온라인 소통 예절을 지켜 공유합니다.",
  },
  {
    id: "social-4-03-01",
    subject: "사회",
  ...
  },
  {
    ...
    subject: "사회",
    gradeBand: "초등 3-4학년",
    title: "[4사09-02] 지역사회를 알리는 노력",
    standard: "[4사09-02] 지역의 자연환경, 역사, 문화, 생산물 등을 알리려는 지역사회의 노력을 알고 관심을 갖는다.",
    classroomGoal: "지역 뉴스를 읽고 지역의 특징을 알리기 위한 노력과 의미를 살펴봅니다.",
  },
  {
    id: "korean-6-01-02",
    subject: "국어",
    gradeBand: "초등 5-6학년",
    title: "[6국01-02] 주장과 근거의 타당성 평가",
    standard: "[6국01-02] 주장을 파악하고 이유나 근거가 타당한지 평가하며 듣는다.",
    classroomGoal: "기사와 발표의 주장을 찾고 제시된 이유와 근거가 타당한지 평가합니다.",
  },
  {
    id: "korean-6-01-03",
    subject: "국어",
  ...
  },
  {
    ...
    subject: "국어",
    gradeBand: "초등 5-6학년",
    title: "[6국01-05] 핵심 정보 중심의 매체 발표",
    standard: "[6국01-05] 자료를 선별하여 핵심 정보를 중심으로 내용을 구성하고 매체를 활용하여 발표한다.",
    classroomGoal: "기사 자료를 선별하고 핵심 정보를 중심으로 발표 내용을 구성합니다.",
  },
  {
    id: "korean-6-01-06",
    subject: "국어",
  ...
  },
  {
    ...
    subject: "국어",
    gradeBand: "초등 5-6학년",
    title: "[6국02-01] 구조를 고려한 주제 파악과 요약",
    standard: "[6국02-01] 글의 구조를 고려하며 주제나 주장을 파악하고 글 내용을 요약한다.",
    classroomGoal: "기사의 구조를 살펴 핵심 주제와 주장을 찾고 내용을 요약합니다.",
  },
  {
    id: "korean-6-02-02",
    subject: "국어",
    gradeBand: "초등 5-6학년",
    title: "[6국02-02] 생략된 내용과 함축 표현 추론",
    standard: "[6국02-02] 글에서 생략된 내용이나 함축된 표현을 문맥을 고려하여 추론한다.",
    classroomGoal: "기사에 직접 드러나지 않은 내용과 표현의 뜻을 문맥과 근거로 추론합니다.",
  },
  {
    id: "korean-6-02-04",
    subject: "국어",
  ...
  },
  {
    ...
    subject: "국어",
    gradeBand: "초등 5-6학년",
    title: "[6국03-06] 글을 독자와 공유하는 태도",
    standard: "[6국03-06] 쓰기에 적극적으로 참여하며 자신의 글을 독자와 공유하는 태도를 지닌다.",
    classroomGoal: "기사에 대한 글을 쓰고 친구들과 공유하며 피드백에 참여합니다.",
  },
  {
    id: "korean-6-06-01",
    subject: "국어",
  ...
  },
  {
    ...
    subject: "국어",
    gradeBand: "초등 5-6학년",
    title: "[6국06-03] 복합양식 매체 자료 제작과 공유",
    standard: "[6국06-03] 적합한 양식과 수용자의 반응을 고려하여 복합양식 매체 자료를 제작하고 공유한다.",
    classroomGoal: "독자의 반응을 고려해 글과 이미지가 결합된 기사 분석 자료를 제작하고 공유합니다.",
  },
  {
    id: "korean-6-06-04",
    subject: "국어",
    gradeBand: "초등 5-6학년",
    title: "[6국06-04] 매체 이용 성찰",
    standard: "[6국06-04] 자신의 매체 이용 양상에 대해 성찰한다.",
    classroomGoal: "뉴스와 온라인 자료를 이용하고 공유한 과정을 돌아보며 개선할 점을 찾습니다.",
  },
  {
    id: "korean-9-01-07",
    subject: "국어",
    gradeBand: "중학교 1-3학년",
    title: "[9국01-07] 토의로 대안 마련하기",
    standard: "[9국01-07] 토의에서 다양한 의견을 교환하여 대안을 마련하고 문제를 해결한다.",
    classroomGoal: "기사의 쟁점에 관한 다양한 의견을 교환하고 실행 가능한 대안을 함께 마련합니다.",
  },
  {
    id: "korean-9-01-08",
    subject: "국어",
    gradeBand: "중학교 1-3학년",
    title: "[9국01-08] 반론을 고려한 논증과 반박",
    standard: "[9국01-08] 토론에서 반론을 고려하여 타당한 논증을 구성하고 논리적으로 반박한다.",
    classroomGoal: "다른 학생의 댓글과 반론을 검토하여 논증을 보완하고 근거를 들어 답글을 작성합니다.",
  },
  {
    id: "social-6-03-02",
    subject: "사회",
  ...
  },
  {
    ...
    subject: "국어",
    gradeBand: "중학교 1-3학년",
    title: "[9국02-05] 설명과 논증 방법의 타당성 평가",
    standard: "[9국02-05] 글에 사용된 다양한 설명 방법과 논증 방법을 파악하고, 그 타당성을 평가하며 읽는다.",
    classroomGoal: "기사의 설명 방식과 논증 구조를 파악하고 주장과 근거의 타당성을 평가합니다.",
  },
  {
    id: "korean-9-02-06",
    subject: "국어",
    gradeBand: "중학교 1-3학년",
    title: "[9국02-06] 같은 화제의 여러 자료 통합 읽기",
    standard: "[9국02-06] 동일한 화제를 다룬 여러 글이나 자료를 주제 통합적으로 읽는다.",
    classroomGoal: "같은 사건을 다룬 여러 언론사의 기사를 비교하여 공통점과 관점 차이를 분석합니다.",
  },
  {
    id: "korean-9-02-07",
    subject: "국어",
    gradeBand: "중학교 1-3학년",
    title: "[9국02-07] 관심 분야 자료 찾아 읽기",
    standard: "[9국02-07] 진로나 관심 분야에 대한 다양한 책이나 자료를 스스로 찾아 읽는다.",
    classroomGoal: "자신의 관심 분야와 관련된 기사와 자료를 스스로 찾아 비교하며 읽습니다.",
  },
  {
    id: "korean-9-02-08",
    subject: "국어",
    gradeBand: "중학교 1-3학년",
    title: "[9국02-08] 읽기 과정 점검과 조정",
    standard: "[9국02-08] 자신의 독서 상황과 수준에 맞는 글을 선정하고 읽기 과정을 점검⋅조정하며 읽는다.",
    classroomGoal: "읽을 기사의 난이도와 적합성을 판단하고 자신의 읽기 과정을 점검합니다.",
  },
  {
    id: "korean-9-03-04",
    subject: "국어",
    gradeBand: "중학교 1-3학년",
    title: "[9국03-04] 사회·문화적 맥락을 고려한 주장 글",
    standard: "[9국03-04] 의견 차이가 있는 사안에 대해 자료를 수집하고 사회⋅문화적 맥락을 고려하며 주장하는 글을 쓴다.",
    classroomGoal: "쟁점과 관련된 기사 자료를 수집하고 사회·문화적 맥락을 고려해 주장 댓글을 씁니다.",
  },
  {
    id: "korean-9-03-07",
    subject: "국어",
    gradeBand: "중학교 1-3학년",
    title: "[9국03-07] 복합양식 자료를 활용한 글쓰기",
    standard: "[9국03-07] 복합양식 자료를 활용하여 내용을 생성하고 글의 유형을 고려하여 내용을 조직하며 글을 쓴다.",
    classroomGoal: "기사의 글·사진·도표를 활용해 내용을 생성하고 목적에 맞게 조직하여 씁니다.",
  },
  {
    id: "korean-9-03-09",
    subject: "국어",
    gradeBand: "중학교 1-3학년",
    title: "[9국03-09] 윤리적 소통 문화 형성",
    standard: "[9국03-09] 언어 공동체의 구성원인 필자로서 자신에 대해 성찰하며, 윤리적 소통 문화를 형성하는 데에 기여한다.",
    classroomGoal: "온라인 댓글 작성자로서 표현을 성찰하고 존중하는 소통 문화에 기여합니다.",
  },
  {
    id: "korean-9-03-08",
    subject: "국어",
  ...
  },
  {
    ...
    subject: "국어",
    gradeBand: "중학교 1-3학년",
    title: "[9국06-01] 대중매체와 개인 방송 비교",
    standard: "[9국06-01] 대중매체와 개인 인터넷 방송의 특성과 영향력을 비교한다.",
    classroomGoal: "신문·방송과 개인 인터넷 방송의 정보 전달 방식과 영향력을 비교합니다.",
  },
  {
    id: "korean-9-06-02",
    subject: "국어",
    gradeBand: "중학교 1-3학년",
    title: "[9국06-02] 상호 작용적 매체 분석",
    standard: "[9국06-02] 소통 맥락과 수용자 참여 양상을 고려하여 상호 작용적 매체를 분석한다.",
    classroomGoal: "댓글과 답글이 이루어지는 맥락과 독자의 참여 양상을 분석합니다.",
  },
  {
    id: "korean-9-06-03",
    subject: "국어",
    gradeBand: "중학교 1-3학년",
    title: "[9국06-03] 영상 매체 자료 제작과 공유",
    standard: "[9국06-03] 복합양식성을 고려하여 영상 매체 자료를 제작하고 공유한다.",
    classroomGoal: "기사 분석 결과를 글·이미지·소리의 관계를 고려한 영상 자료로 제작해 공유합니다.",
  },
  {
    id: "korean-9-06-05",
    subject: "국어",
    gradeBand: "중학교 1-3학년",
    title: "[9국06-05] 매체 자료의 재현 방식 분석",
    standard: "[9국06-05] 매체 자료의 재현 방식을 이해하고 광고나 홍보물을 분석한다.",
    classroomGoal: "기사와 홍보 자료가 대상을 어떤 방식으로 재현하고 강조하는지 분석합니다.",
  },
  {
    id: "social-9-02-02",
    subject: "사회",
