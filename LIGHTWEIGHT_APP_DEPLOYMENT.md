...
## 현재 판정 — 2026-09-18 평가 질문계획 필수 실행 연결
...
## 현재 판정 — 2026-09-18 평가모드 빠른 버튼 정리
...
## 현재 판정 — 2026-09-18 평가기준 질문계획 AI 자동 채움 운영 반영
...
2. 배포 패키지 중 Apps Script가 지원하는 `.js`·`.html`·`appsscript.json` 12개 파일만 **새 프로젝트**에 올린다. README와 `DISTRIBUTION-NOTICE.txt`는 운영 안내이며 스크립트 파일이 아니다. 기존 `gas/.clasp.json`을 복사하거나 기존 프로젝트에서 push하지 않는다.
