...
/** Google's mark has to be the official four-color one; a monochrome icon breaks their brand rules. */
function GoogleMark() {
  return (
...
export function GoogleSignInButton({ label = "Google로 계속하기" }: { label?: string }) {
  return (
...
/** Separates the one-click path from the email form without repeating the rule markup. */
export function AuthDivider({ label = "또는 이메일로" }: { label?: string }) {
  return (
